...
{
    public class HandyManAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
            ...
            public HandyManAuthorizationServerProvider(Func<IAuthorizationRepository> authRepositoryFactory)
            {
